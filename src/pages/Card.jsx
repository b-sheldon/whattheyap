  ...
  const renderCard = () => {
      ...
      return (
        <div className="relative flex flex-row gap-4 p-4 mb-4 bg-purplelight">
          <div className='border-r-2 border-gray-300 basis-full'>
            ...
            <textarea value={question} onChange={(e) => setQuestion(e.target.value)}className='w-11/12 p-2 m-2 text-xl bg-gray-100 resize-none border-box rounded-xl'></textarea>
          </div>
          <div className='basis-full'>
            <p className='text-lg font-bold'>DEFINITION</p>
            <textarea value={answer} onChange={(e) => setAnswer(e.target.value)} className='w-11/12 p-2 m-2 text-xl bg-gray-100 resize-none border-box rounded-xl'></textarea>
          </div>
    ...
    return (
      <div className="relative flex flex-row gap-4 p-4 mb-4 bg-purplelight">
        <div className='border-r-2 border-gray-300 basis-full'>
          <p className='text-lg font-bold'>TERM</p>
          <div className='p-4 text-xl'>{question}</div>
        </div>
        <div className='basis-full'>
          <p className='text-lg font-bold'>DEFINITION</p>
          <div className='p-4 text-xl'>{answer}</div>
        </div>
        <i onClick={toggleEdit}className="absolute text-xl transition-all cursor-pointer top-2 right-2 fa-solid fa-pencil hover:scale-110 hover:text-purpledark"></i>
      </div>
    );
